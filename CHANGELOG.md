...
## [0.2.0](https://github.com/symplasma/iconography/compare/v0.1.7...v0.2.0) - 2026-08-02

### Added

- add flake.nix for Nix development and build support

### Other

- Bump version number
- Add flake.lock
- *(deps)* [**breaking**] Upgrade incompatible dependencies
 ...
 * **Uncategorized**
    - Release iconography v0.1.3 ([`ab5a5b6`](https://github.com/symplasma/iconography/commit/ab5a5b613fafbc78d02d3e5c4bbb0f56cbf9766e))
